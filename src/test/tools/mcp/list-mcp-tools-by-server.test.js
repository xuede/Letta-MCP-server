...
import { handleListMcpToolsByServer, listMcpToolsByServerDefinition } from '../../../tools/mcp/list-mcp-tools-by-server.js';
...
describe('List MCP Tools By Server', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(listMcpToolsByServerDefinition.description).toContain('List all available tools for a specific MCP server');
            expect(listMcpToolsByServerDefinition.inputSchema.required).toEqual(['mcp_server_name']);
            expect(listMcpToolsByServerDefinition.inputSchema.properties).toHaveProperty('mcp_server_name');
            ...
            expect(listMcpToolsByServerDefinition.inputSchema.properties).toHaveProperty('pageSize');
        });
    });
    ...
    describe('Error Handling', () => {
        it('should throw error for missing mcp_server_name', async () => {
            ...
            ).rejects.toThrow('Missing required argument: mcp_server_name');
        });
        ...
        it('should handle other API errors with context', async () => {
            ...
            error.response = { status: 500, data: { error: 'Internal server error', details: 'Connection failed' } };
            mockServer.api.get.mockRejectedValueOnce(error);
