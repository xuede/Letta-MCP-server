...
import { handleAddMcpToolToLetta, addMcpToolToLettaDefinition } from '../../../tools/mcp/add-mcp-tool-to-letta.js';
...
describe('Add MCP Tool to Letta', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(addMcpToolToLettaDefinition.description).toContain('Registers a tool from a connected MCP server');
            expect(addMcpToolToLettaDefinition.inputSchema.required).toEqual(['tool_name', 'agent_id']);
    ...
    describe('Error Handling', () => {
        ...
        it('should throw error when tool not found in any server', async () => {
            ...
            ).rejects.toThrow("Could not find any MCP server providing the tool named 'non-existent-tool'");
        });
        ...
        it('should throw error when registration response missing ID', async () => {
            ...
            ).rejects.toThrow('Registration API call succeeded but did not return the expected tool ID');
        });
    });
