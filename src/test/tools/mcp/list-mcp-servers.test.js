...
import { handleListMcpServers, listMcpServersDefinition } from '../../../tools/mcp/list-mcp-servers.js';
...
describe('List MCP Servers', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(listMcpServersDefinition.description).toContain('List all configured MCP servers');
    ...
    describe('Error Handling', () => {
        it('should handle API errors gracefully', async () => {
            ...
            await expect(
                handleListMcpServers(mockServer, {})
