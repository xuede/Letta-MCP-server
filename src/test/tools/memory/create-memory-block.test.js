...
import { handleCreateMemoryBlock, createMemoryBlockToolDefinition } from '../../../tools/memory/create-memory-block.js';
...
describe('Create Memory Block', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(createMemoryBlockToolDefinition.description).toContain('Create a new memory block');
            expect(createMemoryBlockToolDefinition.inputSchema.required).toEqual(['name', 'label', 'value']);
            ...
            expect(createMemoryBlockToolDefinition.inputSchema.properties).toHaveProperty('agent_id');
            expect(createMemoryBlockToolDefinition.inputSchema.properties).toHaveProperty('metadata');
        });
    });
