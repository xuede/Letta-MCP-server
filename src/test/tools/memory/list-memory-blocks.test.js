...
import { handleListMemoryBlocks, listMemoryBlocksToolDefinition } from '../../../tools/memory/list-memory-blocks.js';
...
describe('List Memory Blocks', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(listMemoryBlocksToolDefinition.inputSchema.properties).toHaveProperty('agent_id');
            expect(listMemoryBlocksToolDefinition.inputSchema.properties).toHaveProperty('page');
            expect(listMemoryBlocksToolDefinition.inputSchema.properties).toHaveProperty('pageSize');
            expect(listMemoryBlocksToolDefinition.inputSchema.properties).toHaveProperty('label');
            expect(listMemoryBlocksToolDefinition.inputSchema.properties).toHaveProperty('templates_only');
            expect(listMemoryBlocksToolDefinition.inputSchema.properties).toHaveProperty('name');
            expect(listMemoryBlocksToolDefinition.inputSchema.properties).toHaveProperty('include_full_content');
        });
    });
    ...
    describe('Functionality Tests', () => {
        it('should list all memory blocks without filters', async () => {
            ...
            expect(data.blocks[0].value_preview).toBe('I am a helpful AI assistant with extensive knowledge');
        ...
        it('should include full content when requested', async () => {
            ...
            const data = expectValidToolResponse(result);
            expect(data.blocks[0].value).toBe('This is the complete value of the memory block with all details');
    ...
    describe('Error Handling', () => {
        it('should handle API errors gracefully', async () => {
            ...
            await expect(
                handleListMemoryBlocks(mockServer, {})
