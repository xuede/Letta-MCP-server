...
import { handleModifyPassage, modifyPassageDefinition } from '../../../tools/passages/modify-passage.js';
...
describe('Modify Passage', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(modifyPassageDefinition.description).toContain('Modify a memory in the agent\'s archival memory');
            expect(modifyPassageDefinition.inputSchema.required).toEqual(['agent_id', 'memory_id', 'update_data']);
            ...
            expect(modifyPassageDefinition.inputSchema.properties).toHaveProperty('include_embeddings');
            expect(modifyPassageDefinition.inputSchema.properties.update_data.required).toEqual(['text']);
            expect(modifyPassageDefinition.inputSchema.properties.include_embeddings.default).toBe(false);
        });
    });
    ...
    describe('Error Handling', () => {
        ...
        it('should handle missing memory_id', async () => {
            ...
            expect(mockServer.createErrorResponse).toHaveBeenCalledWith('Missing required argument: memory_id');
        });
    ...
    describe('Edge Cases', () => {
        it('should handle null args', async () => {
            await expect(
                handleModifyPassage(mockServer, null)
            ).rejects.toThrow();
