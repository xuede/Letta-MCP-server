...
import { handleDeletePassage, deletePassageDefinition } from '../../../tools/passages/delete-passage.js';
...
describe('Delete Passage', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(deletePassageDefinition.description).toContain('Delete a memory from an agent\'s archival memory');
            expect(deletePassageDefinition.description).toContain('WARNING: This action is permanent');
    ...
    describe('Error Handling', () => {
        ...
        it('should handle null args', async () => {
            await expect(
                handleDeletePassage(mockServer, null)
            ).rejects.toThrow();
