...
import { handleCreatePassage, createPassageDefinition } from '../../../tools/passages/create-passage.js';
...
describe('Create Passage', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(createPassageDefinition.description).toContain('Insert a memory into an agent\'s archival memory');
            ...
            expect(createPassageDefinition.inputSchema.properties).toHaveProperty('include_embeddings');
            expect(createPassageDefinition.inputSchema.properties.include_embeddings.default).toBe(false);
        });
    });
    ...
    describe('Error Handling', () => {
        ...
        it('should handle missing text', async () => {
            ...
            expect(mockServer.createErrorResponse).toHaveBeenCalledWith('Missing required argument: text');
        });
        
        it('should handle null args', async () => {
            await expect(
                handleCreatePassage(mockServer, null)
            ).rejects.toThrow();
