...
import { handleCreateAgent, createAgentToolDefinition } from '../../../tools/agents/create-agent.js';
...
describe('Create Agent', () => {
    ...
    describe('Tool Definition', () => {
        ...
        it('should have correct default values', () => {
            expect(createAgentToolDefinition.inputSchema.properties.model.default).toBe('openai/gpt-4');
            expect(createAgentToolDefinition.inputSchema.properties.embedding.default).toBe('openai/text-embedding-ada-002');
        });
    });
    ...
    describe('Functionality Tests', () => {
        it('should create agent successfully with minimal args', async () => {
            ...
            const agentWithTools = { ...createdAgent, tools: [{ name: 'tool1' }, { name: 'tool2' }] };
        ...
        it('should handle agent without tools', async () => {
            const agentWithoutTools = { ...fixtures.agent.basic, id: 'no-tools-agent', tools: undefined };
