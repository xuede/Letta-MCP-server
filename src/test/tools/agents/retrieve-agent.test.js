...
import { handleRetrieveAgent, retrieveAgentDefinition } from '../../../tools/agents/retrieve-agent.js';
...
describe('Retrieve Agent', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(retrieveAgentDefinition.description).toContain('Get the full state of a specific agent');
    ...
    describe('Edge Cases', () => {
        it('should handle empty agent_id string', async () => {
            await expect(
                handleRetrieveAgent(mockServer, { agent_id: '' })
            ).rejects.toThrow('Missing required argument: agent_id');
        });
