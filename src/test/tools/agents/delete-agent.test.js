...
describe('Delete Agent', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(deleteAgentDefinition.description).toContain('WARNING: This action is permanent');
    ...
    describe('Error Handling', () => {
        ...
        it('should handle unauthorized access (401)', async () => {
            ...
            await expect(
                handleDeleteAgent(mockServer, { agent_id: 'agent-123' })
    ...
    describe('Edge Cases', () => {
        it('should handle empty agent_id string', async () => {
            await expect(
                handleDeleteAgent(mockServer, { agent_id: '' })
            ).rejects.toThrow('Missing required argument: agent_id');
        });
        ...
        it('should not retry on 404 errors', async () => {
            ...
            await expect(
                handleDeleteAgent(mockServer, { agent_id: 'not-found' })
            ).rejects.toThrow('Agent not found: not-found');
