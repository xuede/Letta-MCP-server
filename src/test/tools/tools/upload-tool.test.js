...
describe('Upload Tool', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(uploadToolToolDefinition.description).toContain(
                'Upload a new tool to the Letta system',
            );
            expect(uploadToolToolDefinition.inputSchema.required).toEqual([
                'name',
                'description',
                'source_code',
            ]);
