...
import { handleBulkAttachToolToAgents, bulkAttachToolDefinition } from '../../../tools/tools/bulk-attach-tool.js';
...
describe('Bulk Attach Tool', () => {
    ...
    describe('Tool Definition', () => {
        it('should have correct tool definition', () => {
            ...
            expect(bulkAttachToolDefinition.description).toContain('Attaches a specified tool to multiple agents');
            ...
            expect(bulkAttachToolDefinition.inputSchema.properties).toHaveProperty('agent_name_filter');
            expect(bulkAttachToolDefinition.inputSchema.properties).toHaveProperty('agent_tag_filter');
        });
    });
    ...
    describe('Functionality Tests', () => {
        ...
        it('should handle both name and tag filters', async () => {
            const mockAgents = [
                { id: 'agent-4', name: 'Test Production Agent' }
            ];
        ...
        it('should properly encode special characters in IDs', async () => {
            const mockAgents = [
                { id: 'agent/with/slashes', name: 'Special Agent' }
            ];
    ...
    describe('Edge Cases', () => {
        ...
        it('should handle comma-separated tags', async () => {
            const mockAgents = [
                { id: 'agent-1', name: 'Multi-tag Agent' }
            ];
